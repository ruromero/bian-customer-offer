...
public final class Collateral extends RouteBuilder {
    ...
    public void configure() {
        ...
        from("direct:updateCustomerOfferProcedureCollateral")
                .to("log:updateCustomerOfferProcedureCollateral?level=INFO");
        from("direct:exchangeCustomerOfferProcedureCollateralUpdate")
                .to("log:exchangeCustomerOfferProcedureCollateralUpdate?level=INFO");
        from("direct:retrieveCustomerOfferProcedureCollateral")
                .to("log:retrieveCustomerOfferProcedureCollateral?level=INFO");
    }
}
